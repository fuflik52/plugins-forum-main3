...
export const PluginDetail: React.FC = () => {
  ...
  return (
    <div className="min-h-screen p-6" style={{ background: 'var(--gradient-from)' }}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-6 order-2 lg:order-1">
            {/* Plugin Header */}
            <div className="rounded-xl border p-6 shadow-sm" style={{ backgroundColor: 'var(--bg-secondary)', borderColor: 'var(--border-color)' }}>
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    {plugin.plugin_version && (
                      <span className="inline-flex items-center px-3 py-1 text-sm font-semibold rounded-full" style={{ backgroundColor: 'var(--accent-color)', color: 'var(--header-text)' }}>
              ...
              <div className="flex gap-3 mt-6">
                ...
                {plugin.file.html_url && (
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-200 hover:scale-105"
                    style={{ backgroundColor: 'var(--accent-color)', color: 'var(--header-text)' }}
                  >
                ...
                {plugin.file.html_url && (
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-200 hover:scale-105"
                    style={{ backgroundColor: 'var(--status-success)', color: 'var(--header-text)' }}
                  >
                ...
                <div className="space-y-4">
                  ...
                  {(pluginAnalysis.commands.chatCommands.length > 0 ||
                    ...
                    <div className="rounded-lg p-4" style={{ backgroundColor: 'var(--info-bg)' }}>
                      <div className="flex items-center gap-2 mb-3">
                        <Terminal className="h-4 w-4" style={{ color: 'var(--info-text)' }} />
                        <h3 className="font-semibold" style={{ color: 'var(--info-text)' }}>Команды</h3>
                        <span className="text-xs px-2 py-1 rounded-full" style={{ backgroundColor: 'var(--info-border)', color: 'var(--info-text)' }}>
                      ...
                      {pluginAnalysis.commands.chatCommands.length > 0 && (
                        <div className="mb-3">
                          <div className="text-xs font-medium mb-2" style={{ color: 'var(--info-text)' }}>
                            Чат команды (
                            {pluginAnalysis.commands.chatCommands.length})
                          </div>
                            ...
                            {pluginAnalysis.commands.chatCommands.map(
                              (cmd, idx) => (
                                <span
                                  ...
                                  style={{ backgroundColor: 'var(--bg-secondary)', color: 'var(--text-primary)', borderColor: 'var(--info-border)' }}
                                >
                                  /{cmd}
                                </span>
                              )
                  ...
                  {pluginAnalysis.permissions.registered.length > 0 && (
                    <div className="rounded-lg p-4" style={{ backgroundColor: 'var(--success-bg)' }}>
                      <div className="flex items-center gap-2 mb-3">
                        <Shield className="h-4 w-4" style={{ color: 'var(--success-text)' }} />
                        <h3 className="font-semibold" style={{ color: 'var(--success-text)' }}>
                          Права доступа
                        </h3>
                        <span className="text-xs px-2 py-1 rounded-full" style={{ backgroundColor: 'var(--success-border)', color: 'var(--success-text)' }}>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {pluginAnalysis.permissions.registered.map(
                          (perm, idx) => (
                            <span
                              key={idx}
                              className="px-2 py-1 rounded text-xs font-mono border break-all"
                              style={{ backgroundColor: 'var(--bg-secondary)', color: 'var(--text-primary)', borderColor: 'var(--success-border)' }}
                            >
                              {perm}
                            </span>
                          )
                  ...
                  {pluginAnalysis.hooks.oxideHooks.length > 0 && (
                    <div className="rounded-lg p-4" style={{ backgroundColor: 'var(--purple-bg)' }}>
                      <div className="flex items-center gap-2 mb-3">
                        <Zap className="h-4 w-4" style={{ color: 'var(--purple-text)' }} />
                        <h3 className="font-semibold" style={{ color: 'var(--purple-text)' }}>
                          Oxide хуки
                        </h3>
                        <span className="text-xs px-2 py-1 rounded-full" style={{ backgroundColor: 'var(--purple-border)', color: 'var(--purple-text)' }}>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {pluginAnalysis.hooks.oxideHooks.map((hook, idx) => (
                          <span
                            key={idx}
                            className="px-2 py-1 rounded text-xs font-mono border"
                            style={{ backgroundColor: 'var(--bg-secondary)', color: 'var(--text-primary)', borderColor: 'var(--purple-border)' }}
                          >
                            {hook}
                          </span>
                        ))}
                  ...
                  {(pluginAnalysis.dependencies.pluginReferences.length > 0 ||
                    ...
                    <div className="rounded-lg p-4" style={{ backgroundColor: 'var(--warning-bg)' }}>
                      <div className="flex items-center gap-2 mb-3">
                        <Package2 className="h-4 w-4" style={{ color: 'var(--warning-text)' }} />
                      ...
                      {pluginAnalysis.dependencies.pluginReferences.length >
                        0 && (
                        <div className="mb-3">
                          <div className="text-xs font-medium mb-2" style={{ color: 'var(--warning-text)' }}>
                            ...
                            {pluginAnalysis.dependencies.pluginReferences.map(
                              (dep, idx) => (
                                <span
                                  key={idx}
                                  className="px-2 py-1 rounded text-xs font-mono border"
                                  style={{ backgroundColor: 'var(--bg-secondary)', color: 'var(--text-primary)', borderColor: 'var(--warning-border)' }}
                                >
                                  {dep}
                                </span>
                              )
                      ...
                      {pluginAnalysis.config.hasDefaultConfig && (
                        <div className="flex items-center gap-2">
                          <Settings className="h-4 w-4" style={{ color: 'var(--warning-text)' }} />
                          ...
                          {pluginAnalysis.config.configKeys.length > 0 && (
                            <span className="text-xs px-2 py-1 rounded-full" style={{ backgroundColor: 'var(--warning-border)', color: 'var(--warning-text)' }}>
            ...
            {/* File Content */}
            <div className="rounded-xl border p-6 shadow-sm w-full" style={{ backgroundColor: 'var(--bg-primary)', borderColor: 'var(--border-primary)' }}>
          ...
          <div className="space-y-6 order-1 lg:order-2">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3 pt-3 border-t" style={{ borderColor: 'var(--border-color)' }}>
                  <div className="text-center">
                    ...
                    <span className="text-xs" style={{ color: 'var(--text-muted)' }}>Звезды</span>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <span className="text-xs" style={{ color: 'var(--text-muted)' }}>Форки</span>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <span className="text-xs" style={{ color: 'var(--text-muted)' }}>Проблемы</span>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <span className="text-xs" style={{ color: 'var(--text-muted)' }}>Подписчики</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-xl border p-6 shadow-sm" style={{ backgroundColor: 'var(--bg-secondary)', borderColor: 'var(--border-color)' }}>
              ...
              <div className="space-y-3">
                ...
                {plugin.file.sha && (
                  <div className="p-3 rounded-lg" style={{ backgroundColor: 'var(--bg-tertiary)' }}>
                    <div className="text-xs mb-1" style={{ color: 'var(--text-secondary)' }}>SHA:</div>
            ...
            {/* Timeline */}
            <div className="rounded-xl border p-6 shadow-sm" style={{ backgroundColor: 'var(--bg-primary)', borderColor: 'var(--border-primary)' }}>
              <h2 className="text-lg font-bold mb-4 flex items-center gap-2" style={{ color: 'var(--text-primary)' }}>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full mt-2 flex-shrink-0" style={{ backgroundColor: 'var(--success-text)' }}></div>
                  <div>
                    <div className="text-sm font-medium" style={{ color: 'var(--text-primary)' }}>
                      Создан
                    </div>
                ...
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full mt-2 flex-shrink-0" style={{ backgroundColor: 'var(--purple-text)' }}></div>
                  <div>
                    <div className="text-sm font-medium" style={{ color: 'var(--text-primary)' }}>
                      Обновлен
                    </div>
